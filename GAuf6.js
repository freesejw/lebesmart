nnamen = new Array;
      nnamen = ["Wegmann", "Schmidt", "Schneider", "Fischer", "Weber", "Meyer",
        ...
        "Rensen","L�bke","Vieler","Bartke","Witt" ];
      ...
      var ab = 2;                 // Anzahl Basis Objekte f�r den Vergleich mit vrn bzw vrv
      var av = 2;                 // Anzahl Vergleichs Objekte
      var wieSchnell=1;
      var stopDurchlauf;
      var aufschlag;
      ...
      function myTimer() 
      {
        ...
        console.log("aufrufTimer: " + aufrufTimer);
         aufschlag = 1 * ar[0];
        //progressBar();
        ...
        if (aufrufTimer == 5 + aufschlag) {
          Entferne(3);
          ErstellNamensListe(4, nnamen, mrn, 50, 300, 1);
          console.log("Zeige Nachnamen");
        }
    
        if (aufrufTimer == 8 + aufschlag) {
